...
export function initESPHome(
  ...
  stateListener: (state: ESPHomeDoorEvent) => void = _state => {} // listener to events generated by ESP Home
): EventSource {
  this.logger.error('initESPHome');
  ...
  eventSource.addEventListener('state', e => {
    try {
      const b = JSON.parse(e.data) as ESPHomeDoorEvent;
      fn(b);
    } catch (e) {
...
export class GarageDoor implements AccessoryPlugin {
  ...
  private handleDoorState(e: ESPHomeDoorEvent) {
    const Characteristic = this.api.hap.Characteristic;
  ...
  private connectToESPSource(): Promise<EventSource> {
    return new Promise((resolve, reject) => {
      try {
        ...
        const fnDoor = debounce(e => this.handleDoorState(e), DEBOUNCE_TIME);
        //const fnLight = debounce(e => this.handleLightState(e), DEBOUNCE_TIME);
